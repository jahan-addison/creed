...
Crescendum is a minimal, opinionated boilerplate for modern C++ projects. It provides a foundation with essential tooling for code quality, testing, and static analysis without unnecessary complexity. The build system integrates sanitizers, static analyzers, and automated formatting to catch errors, undefined behavior, and segmentation faults early in development.
...
Sanitizers impose runtime overhead but catch bugs that static analysis tools miss. The recommended combination is `Address;Undefined` for general development.
